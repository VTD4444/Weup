...
public class Enemy14 : MonoBehaviour
{
    ...
    {
        transform.position = Vector3.MoveTowards(transform.position, new Vector3(0f,1.3f,0), 1f * Time.deltaTime);
    }

    private void Triangle()
    {
        transform.position = Vector3.MoveTowards(transform.position, new Vector3(0f,2.3f,0), 1f * Time.deltaTime);
    }

    private void Rectangle()
    {
        transform.position = Vector3.MoveTowards(transform.position, new Vector3(0f,3.1f,0), 1f * Time.deltaTime);
    }
}