...
public class Enemy2 : MonoBehaviour
{
    ...
    {
        transform.position = Vector3.MoveTowards(transform.position, new Vector3(0f,4.24f,0), 1f * Time.deltaTime);
    }

    private void Triangle()
    {
        transform.position = Vector3.MoveTowards(transform.position, new Vector3(0f,4.3f,0), 1f * Time.deltaTime);
    }
